...
}}(this,function(){var c="2.1.4-javascript",a={},d,g=[],f=[],e=0,b=Object.prototype.hasOwnProperty;
...
if(a.util.trim(aJ).length===0&&aA.transport==="long-polling"){if(!aB.hasData){R(aB,aA,0)
